    ...
    <>
      ...
      <div className="descriptionkadiv ">
        <ul className="flex flex-col  gap-4 my-4 text-neutral-500 xl:px-5 xl:my-10">
          <li>Hot-swappable mechanical keyboard with Gateron Pro Mechanical key switches.</li>
          <li>QMK/VIA compatible for full customizability.</li>
          <li>Compatible with almost all the MX style 3pin and 5pin mechanical switches.</li>
          <li>Support both wired(detachable USB Type-C cable) and wireless(via bluetooth) connection.</li>
          <li>
           Available with white led and RGB backlit options.
          </li>
          <li>Best performance on FPS Games</li>
          <li>Ergonomic keyboard design to offer the most comfortable gaming and work experience.</li>
          <li>One year domestic warranty</li>
          <li>
            Compatible with both Mac and Windows OS.(x1)
          </li>
        </ul>
      </div>
