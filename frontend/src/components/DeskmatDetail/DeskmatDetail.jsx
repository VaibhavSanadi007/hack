...
const DeskmatDetail = () => {
  ...
  const getMatDetails = async (id) => {
    const data = await axios.get(`${url}/matSpecific/${id}`, {
    ...
    <>
      ...
      <div className="descriptionkadiv ">
        <ul className="flex flex-col  gap-4 my-4 text-neutral-500 xl:px-5 xl:my-10">
          ...
          <li>
            Mecmat is undeniably the last desk mat you would need for a top
            notch experience.
          </li>
          <li>
            Anti slip rubber base keeps the mat firmly in place, allowing for
            remarkable movement speed.
          </li>
          <li>
            Anti-fray stitching provides a clean and finished look to the desk
            mat, making it last exceptionally long and look new as ever.
          </li>
          <li>
            Splash resistant features add to the durability and visual appeal,
            making it suitable for heavy-duty usage.
          </li>
