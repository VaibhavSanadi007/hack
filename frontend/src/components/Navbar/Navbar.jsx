...
const Navbar = () => {
  ...
  return (
    <>
      <div className="h-20 lg:h-30 xl:h-25 xl:px-5 w-full  text-[#FFFFFF]     ">
        <nav className={`h-full w-full   px-[1%] flex items-center justify-between relative z-2  `}>
          <img
            src={logo}
          ...
          <div className="flex gap-10 ">
             ...
             <div className="rounded cursor-pointer py-1 uppercase  group relative active:scale-90 nav-text-mobile" onClick={handleloginNav}>
              Login
              <span className="pointer-events-none absolute  left-0 -bottom-0 h-[1%] bg-white block max-w-0 w-full transition-all duration-300 group-hover:max-w-full"></span>
            </div>
      ...
      <motion.div
        ...
        initial={"Listart"}
        variants={variant}
        className={`anime-navbar  w-[55%] h-[60%] z-3  text-black   absolute md:right-0 md:top-0 xl:right-0 xl:top-0  bg-[#FFFFFF] rounded-b`}
      >
